...
{
    [TestClass]
    public class MathematicialSearchPoint10Test
    {
        [TestMethod]
        public void MathematicialSearchPoint_10Test()          //Проверка ядер свертки
        {
            //arrange
            MathematicialSearchPoint core = new MathematicialSearchPoint10();

            //act
            double[,] exepectedGx = new double[,] { { 0, 0, 1, 0, 0 }, { 0, 1, 2, 1, 0 }, { 1, 2, -16, 2, 1 },{ 0, 1, 2, 1, 0 }, { 0, 0, 1, 0, 0 } };
            double[,] exepectedGy = new double[,] { { 1, 0, 0, 0, 1 }, { 0, 2, 1, 2, 0 }, { 0, 1, -16, 1, 0 },{ 0, 2, 1, 2, 0 }, { 1, 0, 0, 0, 1 } };
        ...
        [TestMethod]
        public void gradientAtPoint10_CornerPoint_Test()              //Проверка градиента  угловой точки
        {
            //arrange
        ...
        [TestMethod]
        public void gradientAtPoint10_BoundaryPoint_Test()              //Проверка градиента  граничной точки
        {
            //arrange
            IParser parser = new Parser();
