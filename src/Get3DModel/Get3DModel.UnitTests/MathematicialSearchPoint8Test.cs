...
{
    [TestClass]
    public class MathematicialSearchPoint8Test
    {
        [TestMethod]
        public void MathematicialSearchPoint_8Test()          //Проверка ядер свертки
        {
            ...
            //act
            double[,] exepectedGx = new double[,] { { 0, 0, 1, 0, 0 }, { 0, 0, 2, 0, 0 }, { 1, 2, -12, 2, 1 },{ 0, 0, 2, 0, 0 }, { 0, 0, 1, 0, 0 } };
            double[,] exepectedGy = new double[,] { { 1, 0, 0, 0, 1 }, { 0, 2, 0, 2, 0 }, { 0, 0, -12, 0, 0 },{ 0, 2, 0, 2, 0 }, { 1, 0, 0, 0, 1 } };
        ...
        [TestMethod]
        public void gradientAtPoint8_IntPoint_Test()              //Проверка градиента  внутренней точки
        {
            //arrange
            IParser parser = new Parser();
            Bitmap img = parser.readPNG("Data\\sample_10.png");
