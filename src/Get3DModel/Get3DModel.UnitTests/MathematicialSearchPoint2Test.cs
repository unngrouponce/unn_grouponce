...
{
    [TestClass]
    public class MathematicialSearchPoint2Test
    {
        [TestMethod]
        public void MathematicialSearchPoint_2Test()          //Проверка ядер свертки
        {
            //arrange
            MathematicialSearchPoint core = new MathematicialSearchPoint2();

            //act
            double[,] exepectedGx = new double[,] { { -1,0,1 }, {-2,0,2 }, { -1,0,1 } };
            double[,] exepectedGy = new double[,] { { -1,-2,-1 }, { 0,0,0 }, { 1,2,1 } };
        ...
        [TestMethod]
        public void gradientAtPoint2_CornerPoint_Test()              //Проверка градиента  угловой точки
        {
            //arrange
        ...
        [TestMethod]
        public void gradientAtPoint2_BoundaryPoint_Test()              //Проверка градиента  граничной точки
        {
            //arrange
            IParser parser = new Parser();
        ...
        [TestMethod]
        public void gradientAtPoint2_IntPoint_Test()              //Проверка градиента  внутренней точки
        {
            //arrange
            IParser parser = new Parser();
            Bitmap img = parser.readPNG("Data\\sample_10.png");
