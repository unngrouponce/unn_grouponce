...
{
    [TestClass]
    public class MathematicialSearchPoint7Test
    {
        [TestMethod]
        public void MathematicialSearchPoint_7Test()          //Проверка ядер свертки
        {
            ...
            //act
            double[,] exepectedGx = new double[,]  { { 1, 1, 1, 0, -1, -1, -1 }, { 1, 1, 2, 0, -2, -1, -1 }, { 1, 2, 3, 0, -3, -2, -1 },
                { 2, 3, 4, 0, -4, -3, -2 }, { 1, 2, 3, 0, -3, -2, -1 }, { 1, 1, 2, 0, -2, -1, -1 }, { 1, 1, 1, 0, -1, -1, -1 } };
            double[,] exepectedGy = new double[,] { { -1, -1, -1, -2, -1, -1, -1 }, { -1, -1, -2, -3, -2, -1, -1 }, { -1, -2, -3, -4, -3, -2, -1 },
        ...
        [TestMethod]
        public void gradientAtPoint7_BoundaryPoint_Test()              //Проверка градиента  граничной точки
        {
            //arrange
            IParser parser = new Parser();
