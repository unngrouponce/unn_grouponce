...
{
    [TestClass]
    public class MathematicialSearchPoint4Test
    {
        [TestMethod]
        public void MathematicialSearchPoint_4Test()          //Проверка ядра свертки
        {
            ...
            //act
            double[,] exepectedG = new double[,] { { 1, -2, 1 }, { -2, 4, -2 }, { 1, -2, 1 } };
        ...
        [TestMethod]
        public void gradientAtPoint4_CornerPoint_Test()              //Проверка градиента  угловой точки
        {
            //arrange
